...
class ToastContainer extends Component {
    ...
    show = () => {
        ...
        if (!this.animating) {
            clearTimeout(this.hideTimeout)
            this.animating                                      = true
            const {animation, animationDuration, duration}: any = this.props
    ...
    hide = () => {
        ...
        clearTimeout(this.hideTimeout)
        if (!this.animating) {
            const {animation, animationDuration, onHidden}: any = this.props
            Animated.timing(this.state.opacity, {
                toValue        : 0,
                duration       : animation ? animationDuration : 0,
    ...
    renderMaskToast = (children: any) => {
        const {maskColor, maskStyle, onMaskPress}: any = this.props
        return (
