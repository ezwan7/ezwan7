...
export default class MyMaterialRipple extends PureComponent {
    static defaultProps = {
        // @ts-ignore
    ...
    onPress(event: any) {
        let {ripples}: any                   = this.state;
        let {onPress, rippleSequential}: any = this.props;
    ...
    onLongPress(event: any) {
        let {onLongPress}: any = this.props;
    ...
    startRipple(event: any) {
        let {width, height}: any = this.state;
        let {
                rippleDuration,
                rippleCentered,
                rippleSize,
    ...
    renderRipple({unique, progress, locationX, locationY, R}: any) {
        let {rippleColor, rippleOpacity, rippleFades}: any = this.props;
